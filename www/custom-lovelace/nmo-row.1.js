class nmoRow extends Polymer.Element {
  ...
  _updateThirds(item) {
    ...
    if(item.root.querySelector("hui-generic-entity-row")) {
      let second = item.root.querySelector("hui-generic-entity-row").root.querySelector("div.flex");
      second = path.querySelector("div.info").querySelector("div.secondary");

      second.querySelectorAll("third").forEach( (third) => {
        let info = third._config;
  ...
  {
    // row =
    // this.dummy.shadowRoot.querySelector("ha-card").querySelector("#states").[firstChild,...]
    ...
    if(row.tagName === 'DIV') {
      ...
      // customizing
      let second;    // [todo] move
      if(entity_row.shadowRoot.querySelector("hui-generic-entity-row")) {
        second = entity_row.shadowRoot.querySelector("hui-generic-entity-row").shadowRoot.querySelector("div.flex").querySelector("div.info").querySelector("div.secondary");  // [todo] move
